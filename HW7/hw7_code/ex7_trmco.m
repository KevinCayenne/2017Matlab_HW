...
% 下面是先把資料讀取進來的語法，這裡是先預設大家把資料矩陣存成'ex7.mat'
load('ex7.mat');
% 這裡預設大家的ex7.mat第一個column是y % 
y=ex7(:,1);
% 這裡預設大家的ex7.mat第三個column是x1，然後中心化 % 
xs1=ex7(:,3); mxs1=ex7(:,3)-mean(ex7(:,3));
% 下面則是建構矩陣X %
xs=[mxs1 ex7(:,4)];
...
a=0; b=100; runmax=1001; tau=10; tolv=10^-6;
% 下面的xmin和xmax，則是我們要定下的x0, x1, x2的最大最小值界限 %
xmin=[1 -1.62 0.01]'; xmax=[1 1.98 0.56]';
